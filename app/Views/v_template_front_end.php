...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <img src="<?= base_url('logo') ?>/aji.png" width="50px" >
      <h1 class="logo me-auto"><a href="index.html">DESA KULU</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <ul>
                  ...
                  <li><a href="#">Gegografis Desa</a></li>
                </ul>
          </li>
          ...
          <ul>
                  ...
                  <li><a href="#">Surat Pindah Datang</a></li>
                </ul>
          </li>
          <li class="dropdown"><a href="#"><span>Kelembagaan</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
                  <li><a href="#">PKK</a></li>
            ...
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Fasilitas</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="#">Peribadatan</a></li>
                  <li><a href="#">Kesehatan</a></li>
                  <li><a href="#">Pemukiman</a></li>
                  <li><a href="#">Pra-Sarana</a></li>
                </ul>
              </li>
