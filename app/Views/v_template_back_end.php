...
<body>
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
							...
							<div class="input-group">
								<h2 style="font-weight: bold; color: white;">DESA KULU</h2>
							</div>
					</div>
                        ...
                        <li class="nav-item">
							...
							<div class="collapse" id="setting">
								<ul class="nav nav-collapse">
                                    ...
                                    <li>
										<a href="components/gridsystem.html">
											<span class="sub-item">Cop Surat</span>
										</a>
									</li>
								</ul>
							</div>
	...
	<!-- Moment JS -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/moment/moment.min.js"></script>

	<!-- Chart JS -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/chart.js/chart.min.js"></script>

	<!-- jQuery Sparkline -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

	<!-- Chart Circle -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/chart-circle/circles.min.js"></script>

	<!-- Datatables -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/datatables/datatables.min.js"></script>

	<!-- Bootstrap Notify -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

	<!-- Bootstrap Toggle -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>

	<!-- jQuery Vector Maps -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script src="<?= base_url('back-end')?>/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

	<!-- Google Maps Plugin -->
	<script src="<?= base_url('back-end')?>/assets/js/plugin/gmaps/gmaps.js"></script>
